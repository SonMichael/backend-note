...
export default class RouterV1 extends Router {
  ...
  private initNoteRouter()
  {
    ...
    this.router.get('/notes/:id', Validate(getNotesValidation.getNotes()), notesController.getNoteById.bind(notesController)); 
    this.router.put('/notes', Validate(getNotesValidation.getUpdateNote()), notesController.updateNote.bind(notesController)); 
    this.router.post('/notes', Validate(getNotesValidation.getCreateNote()), notesController.createNote.bind(notesController)); 
  }
}